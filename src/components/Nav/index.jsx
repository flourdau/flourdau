	...
	<Navbar className={ NavStyle.navbar } expand="xxl" sticky="top" bg="light" data-bs-theme="light">
		...
		<Navbar.Collapse id="basic-navbar-nav">
			<Nav activeKey={Location.pathname} variant="underline">
				<section>
					<Nav.Item>
						<Nav.Link eventKey="/" href={ "/flourdau/" }><span>Home</span></Nav.Link>
					</Nav.Item>

					<Nav.Item>
						<Nav.Link eventKey="/curriculum" href={ "/flourdau/curriculum" }><span>Curriculum Vitae</span></Nav.Link>
					</Nav.Item>

					<Nav.Item>
						<Nav.Link eventKey="/portfolio" href={ "/flourdau/portfolio" }><span>Portfolio</span></Nav.Link>
					</Nav.Item>
